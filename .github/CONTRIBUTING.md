...
**Docker:** Another option is to utilize the [pytorch lightning cuda base docker image](https://hub.docker.com/repository/docker/pytorchlightning/pi_ml/tags?page=1&name=cuda). You can then run:

```bash
python -m pytest pi_ml tests pl_examples -v
```
