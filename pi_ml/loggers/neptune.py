...
from pi_ml.utilities.imports import _NEPTUNE_AVAILABLE, _NEPTUNE_GREATER_EQUAL_0_9
from pi_ml.utilities.logger import _add_prefix, _convert_params, _sanitize_callable_params
from pi_ml.utilities.model_summary import ModelSummary
...
class NeptuneLogger(LightningLoggerBase):
    ...
    **How to use NeptuneLogger?**
    ...
    Use the logger anywhere in your :class:`~pi_ml.core.lightning.LightningModule` as follows:
    ...
    **Log model checkpoints**
    ...
    If you have :class:`~pi_ml.callbacks.ModelCheckpoint` configured,
    ...
    **Details about Neptune run structure**
    ...
    def _verify_input_arguments(
        ...
        legacy_kwargs_msg = (
            ...
            "  - https://docs-legacy.neptune.ai/integrations/pi_ml.html\n"
    ...
    def _signal_deprecated_api_usage(f_name, sample_code, raise_exception=False):
        msg_suffix = (
            ...
            f"  - https://docs-legacy.neptune.ai/integrations/pi_ml.html\n"
