...
from pi_ml.utilities.imports import _compare_version, _module_available
from pi_ml.utilities.logger import _add_prefix, _convert_params, _flatten_dict, _sanitize_callable_params
...
class WandbLogger(LightningLoggerBase):
    ...
    **Log metrics**
    ...
    Log from :class:`~pi_ml.core.lightning.LightningModule`:
    ...
    **Log hyper-parameters**
    ...
    Save :class:`~pi_ml.core.lightning.LightningModule` parameters:
    ...
    **Log model checkpoints**
    ...
    Custom checkpointing can be set up through :class:`~pi_ml.callbacks.ModelCheckpoint`:
    ...
    **Log Tables**
    ...
    Args:
        ...
        log_model: Log checkpoints created by :class:`~pi_ml.callbacks.model_checkpoint.ModelCheckpoint`
            as W&B artifacts. `latest` and `best` aliases are automatically set.

            * if ``log_model == 'all'``, checkpoints are logged during training.
            * if ``log_model == True``, checkpoints are logged at the end of training, except when
              :paramref:`~pi_ml.callbacks.model_checkpoint.ModelCheckpoint.save_top_k` ``== -1``
    ...
    def experiment(self) -> Run:
        ...
        :class:`~pi_ml.core.lightning.LightningModule` do the following.
