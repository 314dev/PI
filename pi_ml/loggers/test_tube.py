...
from pi_ml.utilities.logger import _add_prefix, _convert_params, _flatten_dict
from pi_ml.utilities.rank_zero import rank_zero_deprecation, rank_zero_only, rank_zero_warn
...
class TestTubeLogger(LightningLoggerBase):
    ...
    .. code-block:: python
        ...
        from pi_ml.loggers import TestTubeLogger
    ...
    def __init__(
        ...
        rank_zero_deprecation(
            ...
            " `pi_ml.loggers.TensorBoardLogger` as an alternative."
        )
