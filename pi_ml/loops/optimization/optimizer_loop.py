...
from pi_ml.loops.optimization.closure import AbstractClosure, OutputResult
from pi_ml.loops.utilities import (
    _block_parallel_sync_behavior,
    _build_training_step_kwargs,
    _extract_hiddens,
    check_finite_loss,
)
from pi_ml.trainer.progress import OptimizationProgress
from pi_ml.utilities import _AcceleratorType, AMPType
from pi_ml.utilities.exceptions import MisconfigurationException
from pi_ml.utilities.finite_checks import detect_nan_parameters
from pi_ml.utilities.imports import _TPU_AVAILABLE
...
class Closure(AbstractClosure[ClosureResult]):
    ...
    Args:
        step_fn: This is typically the :meth:`pi_ml.core.lightning.LightningModule.training_step
