...
from pi_ml.utilities.rank_zero import rank_zero_info, rank_zero_warn
from pi_ml.utilities.types import _METRIC, _PATH, STEP_OUTPUT
...
class ModelCheckpoint(Callback):
    ...
    :meth:`~pi_ml.core.lightning.log` or :meth:`~pi_ml.core.lightning.log_dict` in
    ...
    Args:
        dirpath: directory to save the model file.
            ...
            specified by :class:`~pi_ml.trainer.trainer.Trainer`'s
            :paramref:`~pi_ml.trainer.trainer.Trainer.default_root_dir` or
            :paramref:`~pi_ml.trainer.trainer.Trainer.weights_save_path` arguments,
