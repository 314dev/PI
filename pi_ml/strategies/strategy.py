...
import pi_ml as pl
from pi_ml.core.optimizer import _init_optimizers_and_lr_schedulers, LightningOptimizer
from pi_ml.overrides.base import unwrap_lightning_module
from pi_ml.plugins import TorchCheckpointIO
...
from pi_ml.utilities.types import _PATH, LRSchedulerConfig, STEP_OUTPUT
...
class Strategy(ABC):
    ...
    def training_step(self, *args, **kwargs) -> STEP_OUTPUT:
        ...
        See :meth:`~pi_ml.core.lightning.LightningModule.training_step` for more details
        """
    ...
    def validation_step(self, *args, **kwargs) -> Optional[STEP_OUTPUT]:
        ...
        See :meth:`~pi_ml.core.lightning.LightningModule.validation_step` for more details
        """
    ...
    def test_step(self, *args, **kwargs) -> Optional[STEP_OUTPUT]:
        ...
        See :meth:`~pi_ml.core.lightning.LightningModule.test_step` for more details
        """
    ...
    def predict_step(self, *args, **kwargs) -> STEP_OUTPUT:
        ...
        See :meth:`~pi_ml.core.lightning.LightningModule.predict_step` for more details
        """
