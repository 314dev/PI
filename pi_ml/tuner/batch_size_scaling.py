...
from pi_ml.utilities.data import has_len_all_ranks
from pi_ml.utilities.exceptions import MisconfigurationException
from pi_ml.utilities.memory import garbage_collection_cuda, is_oom_error
from pi_ml.utilities.parsing import lightning_getattr, lightning_hasattr, lightning_setattr
...
def scale_batch_size(
    ...
    """See :meth:`~pi_ml.tuner.tuning.Tuner.scale_batch_size`"""
...
def _adjust_batch_size(
    ...
    Args:
        trainer: instance of pi_ml.Trainer
