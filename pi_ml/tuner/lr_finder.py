...
from pi_ml.core.optimizer import _init_optimizers_and_lr_schedulers, _set_scheduler_opt_idx
from pi_ml.loggers.base import DummyLogger
from pi_ml.utilities.exceptions import MisconfigurationException
from pi_ml.utilities.parsing import lightning_hasattr, lightning_setattr
...
def lr_find(
    ...
    """See :meth:`~pi_ml.tuner.tuning.Tuner.lr_find`"""
