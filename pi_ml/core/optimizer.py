...
from pi_ml.utilities.types import _Stateful, LRSchedulerConfig, LRSchedulerTypeTuple, ReduceLROnPlateau
...
class LightningOptimizer:
    ...
    def toggle_model(self, sync_grad: bool = True) -> Generator[None, None, None]:
        ...
        from pi_ml.loops.utilities import _block_parallel_sync_behavior
