...
from pi_ml.utilities import move_data_to_device
from pi_ml.utilities.types import EVAL_DATALOADERS, STEP_OUTPUT, TRAIN_DATALOADERS
...
class ModelHooks:
    ...
    def on_before_optimizer_step(self, optimizer: Optimizer, optimizer_idx: int) -> None:
        ...
        See: :paramref:`~pi_ml.trainer.Trainer.accumulate_grad_batches`.
    ...
    def on_post_move_to_device(self) -> None:
        ...
        :meth:`~pi_ml.core.LightningModule.to` is called. This is a good place to tie weights between
...
class DataHooks:
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        :paramref:`~pi_ml.trainer.Trainer.reload_dataloaders_every_n_epochs` to
        a positive integer.
