...
from pi_ml.core.hooks import CheckpointHooks, DataHooks
from pi_ml.core.mixins import HyperparametersMixin
from pi_ml.utilities import rank_zero_deprecation
from pi_ml.utilities.argparse import add_argparse_args, from_argparse_args, get_init_arguments_and_types
    ...
    def from_argparse_args(cls, args: Union[Namespace, ArgumentParser], **kwargs):
        ...
        Args:
            args: The parser or namespace to take arguments from. Only known arguments will be
                parsed and passed to the :class:`~pi_ml.core.datamodule.LightningDataModule`.
