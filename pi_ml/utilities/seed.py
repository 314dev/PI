...
def seed_everything(seed: Optional[int] = None, workers: bool = False) -> int:
    ...
    Args:
        ...
        workers: if set to ``True``, will properly configure all dataloaders passed to the
            ...
            :func:`~pi_ml.utilities.seed.pl_worker_init_function`.
    """
...
def reset_seed() -> None:
    """Reset the seed to the value that :func:`pi_ml.utilities.seed.seed_everything` previously set.

    If :func:`pi_ml.utilities.seed.seed_everything` is unused, this function will do nothing.
    """
