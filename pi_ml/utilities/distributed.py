...
import pi_ml as pl
from pi_ml.utilities.imports import _TORCH_GREATER_EQUAL_1_8, _TORCH_GREATER_EQUAL_1_9, _TPU_AVAILABLE
from pi_ml.utilities.rank_zero import rank_zero_debug as new_rank_zero_debug
from pi_ml.utilities.rank_zero import rank_zero_only  # noqa: F401
from pi_ml.utilities.rank_zero import rank_zero_deprecation
from pi_ml.utilities.rank_zero import rank_zero_info as new_rank_zero_info
...
def rank_zero_info(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "pi_ml.utilities.distributed.rank_zero_info has been deprecated in v1.6"
...
def rank_zero_debug(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        "pi_ml.utilities.distributed.rank_zero_debug has been deprecated in v1.6"
        " and will be removed in v1.8."
        " Use the equivalent function from the pi_ml.utilities.rank_zero module instead."
    )
