...
import pi_ml as pl
from pi_ml import Callback, LightningDataModule, LightningModule, seed_everything, Trainer
from pi_ml.utilities.cloud_io import get_filesystem
from pi_ml.utilities.exceptions import MisconfigurationException
from pi_ml.utilities.imports import _JSONARGPARSE_AVAILABLE
from pi_ml.utilities.model_helpers import is_overridden
from pi_ml.utilities.rank_zero import _warn, rank_zero_warn
from pi_ml.utilities.types import LRSchedulerType, LRSchedulerTypeTuple, LRSchedulerTypeUnion
...
class LightningCLI:
    ...
    def __init__(
        ...
        Args:
            model_class: An optional :class:`~pi_ml.core.lightning.LightningModule` class to train on or a
                callable which returns a :class:`~pi_ml.core.lightning.LightningModule` instance when
                called. If ``None``, you can pass a registered model with ``--model=MyModel``.
            datamodule_class: An optional :class:`~pi_ml.core.datamodule.LightningDataModule` class or a
                callable which returns a :class:`~pi_ml.core.datamodule.LightningDataModule` instance when
            ...
            trainer_class: An optional subclass of the :class:`~pi_ml.trainer.trainer.Trainer` class or a
                callable which returns a :class:`~pi_ml.trainer.trainer.Trainer` instance when called.
            ...
            seed_everything_default: Default value for the :func:`~pi_ml.utilities.seed.seed_everything`
                seed argument.
            ...
            subclass_mode_data: Whether datamodule can be any `subclass
                <https://jsonargparse.readthedocs.io/en/stable/#class-type-and-sub-classes>`_
                of the given class.
            run: Whether subcommands should be added to run a :class:`~pi_ml.trainer.trainer.Trainer`
    ...
    def configure_optimizers(
        ...
        """Override to customize the :meth:`~pi_ml.core.lightning.LightningModule.configure_optimizers`
        method.
    ...
    def _add_configure_optimizers_method_to_model(self, subcommand: Optional[str]) -> None:
        """Overrides the model's :meth:`~pi_ml.core.lightning.LightningModule.configure_optimizers`
