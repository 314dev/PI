...
from pi_ml.plugins import PLUGIN_INPUT
from pi_ml.strategies import DDPSpawnStrategy, DeepSpeedStrategy, Strategy, TPUSpawnStrategy
from pi_ml.strategies.strategy import TBroadcast
from pi_ml.trainer.connectors.accelerator_connector import AcceleratorConnector
from pi_ml.utilities import _AcceleratorType, _StrategyType, move_data_to_device
...
from pi_ml.utilities.device_parser import _parse_devices
...
class LightningLite(ABC):
    ...
    def seed_everything(seed: Optional[int] = None, workers: Optional[bool] = None) -> int:
        ...
        See :func:`pi_ml.seed_everything` for more details.
        """
        if workers is None:
