...
from pi_ml.utilities.data import extract_batch_size
...
class _ResultMetric(Metric, DeviceDtypeModuleMixin):
    """Wraps the value provided to `:meth:`~pi_ml.core.lightning.LightningModule.log`"""
...
class _ResultMetricCollection(dict):
    ...
    :class:`~pi_ml.trainer.connectors.logger_connector.result._ResultMetric`
...
class _ResultCollection(dict):
    """
    Collection (dictionary) of :class:`~pi_ml.trainer.connectors.logger_connector.result._ResultMetric` or
    :class:`~pi_ml.trainer.connectors.logger_connector.result._ResultMetricCollection`
    ...
    def log(
        ...
        """See :meth:`~pi_ml.core.lightning.LightningModule.log`"""
