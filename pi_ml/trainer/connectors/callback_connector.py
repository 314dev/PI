...
from pi_ml.utilities import ModelSummaryMode
...
class CallbackConnector:
    ...
    def on_trainer_init(
        ...
        if stochastic_weight_avg:
            rank_zero_deprecation(
                ...
                " Please pass `pi_ml.callbacks.stochastic_weight_avg.StochasticWeightAveraging`"
        ...
        if process_position != 0:
            rank_zero_deprecation(
                ...
                " in v1.7. Please pass `pi_ml.callbacks.progress.TQDMProgressBar` with"
        ...
        if progress_bar_refresh_rate is not None:
            rank_zero_deprecation(
                ...
                " will be removed in v1.7. Please pass `pi_ml.callbacks.progress.TQDMProgressBar` with"
    ...
    def _configure_model_summary_callback(
        ...
        if weights_summary == "top":
            ...
            rank_zero_deprecation(
                ...
                " in v1.7. Please pass `pi_ml.callbacks.model_summary.ModelSummary` with"
    ...
    def _attach_model_callbacks(self) -> None:
        ...
        In addition, all :class:`~pi_ml.callbacks.model_checkpoint.ModelCheckpoint` callbacks
