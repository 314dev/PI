...
from pi_ml.utilities import LightningEnum
from pi_ml.utilities.enums import _FaultTolerantMode


class TrainerStatus(LightningEnum):
    """Enum for the status of the :class:`~pi_ml.trainer.trainer.Trainer`"""
...
class TrainerFn(LightningEnum):
    """
    Enum for the user-facing functions of the :class:`~pi_ml.trainer.trainer.Trainer`
    such as :meth:`~pi_ml.trainer.trainer.Trainer.fit` and
...
@dataclass
class TrainerState:
    """Dataclass to encapsulate the current :class:`~pi_ml.trainer.trainer.Trainer` state."""
